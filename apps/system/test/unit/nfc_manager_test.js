...
suite('Nfc Manager Functions', function() {
  ...
  suite('_changeHardwareState', function() {
    ...
    suite('DOMRequest handlers call proper methods.', function() {
      var fakeDOMRequest;
      ...
      test('disabling, dom req succees', function() {
        nfcManager._changeHardwareState(nfcManager.NFC_HW_STATE.DISABLING);
      ...
      test('disabling, dom req error', function() {
        nfcManager._changeHardwareState(nfcManager.NFC_HW_STATE.DISABLING);
      ...
      test('enabling, dom req success', function() {
        nfcManager._changeHardwareState(nfcManager.NFC_HW_STATE.ENABLING);
        fakeDOMRequest.fireSuccess();
      ...
      test('enabling, dom req error', function() {
        nfcManager._changeHardwareState(nfcManager.NFC_HW_STATE.ENABLING);
        fakeDOMRequest.fireError({});
      ...
      test('enable discovery, dom success', function() {
        nfcManager.
      ...
      test('disable discover, dom error', function() {
        nfcManager.
          _changeHardwareState(nfcManager.NFC_HW_STATE.DISABLE_DISCOVERY);
        fakeDOMRequest.fireError({});
